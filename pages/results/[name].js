        ...
        <div className="bg-gray-100 min-h-screen px-20">
            ...
            <div className="mt-10">
                ...
                <div className="grid gap-2 grid-cols-2">
                    <div>
                        <img className="h-full rounded-l-2xl" src="https://flowbite.s3.amazonaws.com/docs/gallery/featured/image.jpg" alt=""/>
                    </div>
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div>
                            <img className="rounded-tr-2xl" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-2.jpg" alt=""/>
                        </div>
                        <div>
                            <img src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-3.jpg" alt=""/>
                        </div>
                        <div>
                            <img className="rounded-br-2xl" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-4.jpg" alt=""/>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid gap-4 grid-cols-5">
                    ...
                    <div className="bg-white my-6 rounded-2xl shadow-lg col-span-2">
                        <div className="m-5 flex flex-row">
                            <p><b className="text-2xl">${price} CAD</b> + tax</p>
                        </div>
                    </div>
                </div>
            </div>
